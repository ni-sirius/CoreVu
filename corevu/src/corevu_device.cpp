...
void CoreVuDevice::transitionImageLayout(
...
void CoreVuDevice::populateDebugMessengerCreateInfo(
...
SwapChainSupportDetails CoreVuDevice::querySwapChainSupport(
...
uint32_t CoreVuDevice::findMemoryType(
