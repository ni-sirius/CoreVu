...
VkResult CoreVuSwapChain::acquireNextImage(uint32_t *imageIndex) {
  vkWaitForFences(
      device.device(),
      1,
...
VkResult CoreVuSwapChain::submitCommandBuffers(
...
void CoreVuSwapChain::createImageViews() {
...
void CoreVuSwapChain::createRenderPass() {
...
void CoreVuSwapChain::createFramebuffers() {
...
void CoreVuSwapChain::createSyncObjects() {
...
VkExtent2D CoreVuSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat CoreVuSwapChain::findDepthFormat() {
